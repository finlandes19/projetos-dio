...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        ...
        print("\nO Valor do Saque Excede o Limite Contratado.")
        ...
        print("================ SALDO =================")
        print(f"Saldo: R$ {saldo:.2f}")
        print(f"Saques Restantes: {saques_restantes:.1f} ")
...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    print("\nUsuário não encontrado, Por Favor verifique e tente novamente. Criação de Nova Conta Não Realizada")
